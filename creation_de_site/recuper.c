...
char* create_directory(char*directory);
...
char* create_directory(char*directory){
	...
	if(strstr(directory,"/home/misa/")==NULL){
		...
		sprintf(dir,"/home/misa/%s",directory);
	...
	system(allow);
	system(credir);
	sprintf(index,"sudo cp /home/misa/Documents/recuperation/indexe.css /home/misa/Documents/recuperation/index.html %s",dir);
